...
| **v1.2.0** | ✅ Stable | Multi-provider AI translation , Transcripts save           |
...
```
# 🚀 v1.2.0 — Multi-Provider + Transcript Saving

**Stable release**

v1.2.0 builds on the multi-provider architecture introduced in v1.1.0.

This release keeps the **one configured/default model per provider** architecture and adds **timestamped transcript saving**.
...
* 💾 Generated transcripts saved locally
* 📁 `transcripts/` directory
* ⏱️ Whisper segment timestamps preserved
* ⬇️ Transcript download
* 🧭 Provider selection from the sidebar
* 🔌 Translation Provider Factory
* 🔐 Environment-based API-key configuration
* 🔒 API keys hidden from the UI
* ⚙️ Provider configuration/status
* 📄 SRT/VTT generation
* 🔥 FFmpeg caption burning
* 💾 Original uploaded video preservation
...
## v1.2.0 Transcript Storage

Generated transcripts are saved locally in:
...
Each transcript preserves the timestamps generated by Whisper:
...
## v1.2.0 Provider Model Architecture

Unlike v1.3.0, v1.2.0 uses **one configured/default model for each provider**.
...
The dynamic multi-model selection introduced later in **v1.3.0** is not part of v1.2.0.
...
**Multi-Provider AI Translation + Timestamped Transcript Saving**

v1.2.0 adds persistent timestamped transcript storage while retaining the multi-provider architecture with one configured/default model per provider.
...
![AI Video Caption Generator](docs/screenshots/AI-Video-Caption-Generator-combined-pic.png)
